<%@ Page Title="" Language="C#" MasterPageFile="~/View/MasterPage.Master" AutoEventWireup="true" CodeBehind="UpdateEmployee.aspx.cs" Inherits="Project_PSD.View.Manage_Employee.UpdateEmployee" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Label ID="EmployeeID" runat="server" Text="Update_Employee"></asp:Label>
    <br />
    <br />
    ...
    <br />
    <br />
    <asp:Button ID="btnUpdateEmployee" runat="server" Text="Update" OnClick="btnUpdate_Click"/>
    <br />
